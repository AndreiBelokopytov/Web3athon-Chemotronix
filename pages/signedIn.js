      ...
      <main className="flex justify-center ">
        <div className="container px-5">
            ...
            <div className="mt-24">
              ...
              {
                sub && (
                  <div id="authentication-modal" tabIndex="-1" aria-hidden="true" className=" bg-white fixed justify-center items-center flex top-0 h-full right-0 left-0 z-50 w-full h-modal">
                      <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                          {/* Modal content  */}
                          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                              <button type="button" onClick={openSubcribe} className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="authentication-modal">
                                  <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                                  <span className="sr-only">Close modal</span>
                              </button>
                              <div className="py-6 px-6 lg:px-8">
                                  <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Subscribe to our platform</h3>
                                  <form className="space-y-6" onSubmit={handleSubscribe}>
                                      <div>
                                          <input type="number" name="ioT" onChange={(e)=> setIot(e.target.value)} id="ioT" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="unique IoT" required/>
                                      </div>
                                      <div>
                                          
                                          <input type="number" name="deposit" id="deposit" onChange={(e)=> setDeposit(e.target.value)} placeholder="Enter deposit" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required/>
                                      </div>
                                      <button type="submit" className="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Subscribe</button>
                                  </form>
                              </div>
                          </div>
                      </div>
                    ...
                    <div className="lg:w-9/12 flex flex-col md:flex-row overflow-hidden">
                        ...
                        <div className="flex flex-col justify-center ">
                            <p>Welcome,</p>
                             ...
                             {account ? (
                                <div className="flex ">
                                  <Wmenu account={account} disconnect={() => disconnect()} />
                                  <div className="bg-[#008036] cursor-pointer ml-4 px-3 py-1 rounded-md text-white" onClick={openSubcribe}>Subscribe</div>
                                </div>
                ...
                <div className="container flex flex-col lg:flex-row justify-center">
                    ...
                    <div className="lg:w-1/2 lg:flex lg:justify-end items-center">
                      <div className=" relative w-auto">
                        <div className="bg-slate-50 border-4 cursor-pointer border-green-200 rounded-lg px-8 py-2 flex  justify-center items-center" onClick={toggleBuyCarbon}>
